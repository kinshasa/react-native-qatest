...
export default class Badge extends Component {
    ...
    setNativeState(count){
        this.setState({count});
    }

    render () {
        return (
            <Animatable.View animation="pulse" easing={Easing.bezier(0, 0, 0.2, 10)} delay={0} iterationCount={2} ref={ component => this._container = component } style={[styles.container, this.props.style]}>
