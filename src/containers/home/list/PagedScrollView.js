...
var _jsxFileName = 'src/PagedScrollView.js';
...
var AddPaging = function AddPaging(ComposedComponent, scrollViewRefPropName) {
    var ComposedClass = function (_Component) {
        _inherits(ComposedClass, _Component);
        function ComposedClass(props) {
            _classCallCheck(this, ComposedClass);
            var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ComposedClass).call(this,
                props));
...
// We'll consider these state variables although maybe we shouldn't:
        ...
        _createClass(ComposedClass, [{
            ...
            key: '_handleScroll', value: function _handleScroll(event) {
...
// These are important, but they're not state variables that trigger an update:
            ...
            key: '_measureScrollView', value: function _measureScrollView(cb) {
                var _this2 = this;
                ...
                try{
                    responder.ScrollView.measure(function (x, y, w, h) {
                        _this2.scrollViewWidth = w;
                        _this2.scrollViewHeight = h;
                        cb && cb();
                    });
                }catch (e){
                    //console.log('PagedScrollView',responder)
                }

            }
        }, {
            key: '_measureInnerScrollView', value: function _measureInnerScrollView(cb) {
                var _this3 = this;
                var responder = this.getScrollResponder();
                if (!responder) {
                    return;
                ...
                try{
                    responder.InnerScrollView.measure(function (x, y, w, h) {
            ...
            key: '_handleContentSizeChange', value: function _handleContentSizeChange(width, height) {
...
// Get values from event:
            ...
            key: 'scrollToPage', value: function scrollToPage(horizontalPage, verticalPage, animated) {
                if (this._scrollView) {
...
// once they've both returned.
                    ...
                    _this4._measureScrollView(computeNewState);
                });
            }
        }, {
            key: 'getScrollViewRef', value: function getScrollViewRef(c) {
                this._scrollView = c;
            }
        }, {
