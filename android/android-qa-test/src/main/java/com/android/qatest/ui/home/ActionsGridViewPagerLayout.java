...
public class ActionsGridViewPagerLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        mActionPagerIndicator.setBackgroundColor(0xFF990000);
        ...
        addView(mActionPagerIndicator,new LayoutParams(LayoutParams.MATCH_PARENT, 40));

        LayoutParams params = (LayoutParams) mActionPagerIndicator.getLayoutParams();
        params.addRule(ALIGN_PARENT_BOTTOM, mActionsPager.getId());//com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignBottom
    }
